      ...
      <EventModal />
        ...
        <div className="relative flex flex-col items-center justify-center flex-1 p-5 min-h-[80vh]">
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            {/* GITHUB LINK */}
            <a href="https://github.com/prasen-shakya/Schedulify" className="cursor-pointer"><span className="badge">Github 
            ...
            <div className="min-w-[25vw]">
              ...
              <p className="py-6">
                <ul className="steps steps-vertical text-xl">
                  ...
                  <li className="step step-primary">Share with participants</li> 
                  <li className="step step-primary">See what times work best!</li> 
                </ul> 
              </p>
            </div>
          </div>
